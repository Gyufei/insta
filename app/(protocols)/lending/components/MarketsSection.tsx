                  ...
                  return (
                    <div key={m.market_address} className="grid grid-cols-[280px_1fr_1fr_1fr_140px] items-center px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="text-sm font-semibold text-slate-900">{m.token0.name || m.market_name}</div>
                          <div className="text-xs text-slate-500">{m.token0.symbol}</div>
                        </div>
                      </div>
                      <div>
                      ...
                      <div className="text-right">
                        <Link
                          href={`/lending/market/${m.market_address}`}
