  ...
  return (
    <div className="flex flex-grow flex-col gap-4 px-6">
      ...
      <button
        ...
        className="bg-blue shadow-cta scale-xs flex flex-shrink-0 cursor-pointer items-center justify-center rounded-sm px-4 py-2 text-sm leading-none font-semibold whitespace-nowrap text-white duration-75 ease-out select-none focus:outline-none dark:shadow-none"
